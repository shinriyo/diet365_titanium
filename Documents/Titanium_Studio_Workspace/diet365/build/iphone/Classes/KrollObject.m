 ...
 * Copyright (c) 2009-2011 by joking, Inc. All Rights Reserved.
...
//@interface jokingObject : NSObject
//@end

@interface jokingObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[jokingObject class]])
		{
			for (NSString *key in [[(jokingObject*)o modules] allKeys])
			{
