...
static NSString * const kjokingJavascript = @"Ti.App={};Ti.API={};Ti.App._listeners={};Ti.App._listener_id=1;Ti.App.id=Ti.appId;Ti.App._xhr=XMLHttpRequest;"
...
-(NSString*)_jokingInjection
{
	...
	[html appendString:kjokingJavascript];
...
{
	// attempt to make well-formed HTML and inject in our joking bridge code
	...
	if (range.location!=NSNotFound)
	{
		...
		if (nextRange.location!=NSNotFound)
		{
			...
			[html appendString:[self _jokingInjection]];
