...
// in simulator we redefine to format for joking Developer console
...
{\
	NSString * exceptionName = [@"org.joking." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.joking";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UIjokingNativeItemNone = -1, 
	UIjokingNativeItemSpinner = -2,
	UIjokingNativeItemProgressBar = -3,
	
	UIjokingNativeItemSlider = -4,
	UIjokingNativeItemSwitch = -5,
	UIjokingNativeItemMultiButton = -6,
	UIjokingNativeItemSegmented = -7,
	
	UIjokingNativeItemTextView = -8,
	UIjokingNativeItemTextField = -9,
	UIjokingNativeItemSearchBar = -10,
	
	UIjokingNativeItemPicker = -11,
	UIjokingNativeItemDatePicker = -12,
	
	UIjokingNativeItemInfoLight = -13,
	UIjokingNativeItemInfoDark = -14,
	
	UIjokingNativeItemDisclosure = -15,
	
	UIjokingNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all joking instances of
